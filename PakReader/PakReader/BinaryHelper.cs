...
namespace PakReader
{
    public static class BinaryHelper
    {
        ...
        //Stream.Read may return fewer bytes than asked for; the pak parser assumed it
        //always filled the buffer, so a short read silently produced garbled asset data.
        //Kept as a named helper so the call sites read clearly and stay covered by tests.
