...
namespace MCDSaveEdit.ViewModels
{
    public class MainViewModel
    {
        ...
        public async Task handleFileSaveAsync(string? filePath, ProfileSaveFile profile)
        {
            ...
            //Before anything is written, and on every save rather than once a session: the
            //save that ruins a character is rarely the first one. Both Save and Save As come
            //through here, so this is the only place it needs to happen.
            SaveBackup.backup(filePath!);
