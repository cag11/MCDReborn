...
namespace MCDSaveEdit.Services
{
    public class PakContentResolver : IImageResolver, ILanguageResolver
    {
        ...
        /// <summary>
        /// The mounted paks, so features that need the raw assets - the custom skins tab reads
        /// and rewrites textures - can use the index that is already open rather than spending
        /// another minute mounting 1.2GB of their own.
        /// </summary>
        public PakIndex pakIndex => _pakIndex;
