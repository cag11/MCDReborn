...
namespace MCDSaveEdit.UI
{
    ...
    public partial class NetheriteEnchantmentControl : UserControl
    {
        ...
        public void updateUI()
        {
            ...
            netheriteEnchantmentImage.Source = ImageResolver.instance.imageSourceForEnchantment(enchantment!);
        ...
        private void enchantmentImageButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            selectionWindow.loadEnchantments(enchantment?.Id, this.item);
