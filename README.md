...
* Armor, melee, ranged, artifacts, **capes and pets**, picked one category at a time; the cosmetics are read out of the paks, so the list follows whatever game and DLC are installed
